...
public class Login {
    ...
    public Boolean PerformLogin(String Username, String Password) throws InterruptedException {
        ...
        Thread.sleep(5000);
        //WebDriverWait wait = new WebDriverWait(driver, 30); // Maximum timeout of 30 seconds
        //By loginButtonLocator = By.xpath("//*[@id='root']/div/div/div[1]/div[3]/button[1]");
        //FluentWait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(30)).pollingEvery(Duration.ofMillis(250));
